...
const Header = () => {
  ...
  return (
    <header className="md:hidden sticky top-0 inset-x-0 z-10 p-4 flex items-center justify-between bg-[white] dark:bg-primarydark border-t-0 border-r-0 border-l-0 border-b border-solid border-[#E2E8F0] dark:border-[#E2E8F022]">
